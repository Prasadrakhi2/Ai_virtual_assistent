...
const SignUp = () => {
  ...
  return (
    <div className='relative w-full min-h-screen bg-cover flex justify-center items-center flex-col' style={{ backgroundImage: `url(${bgImage})` }}>
      <form onSubmit={handleSignUp} className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] p-[20px]'>
